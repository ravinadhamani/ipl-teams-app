    ...
    render() {
        ...
        return (
            <div className={styles.formStyle}>
                <h1 className={styles.teamRegistrationTxt}>Player Registration</h1>
                <div>
                    <p className={styles.nameStyles}>Player Name</p>
                    <input class={styles.inputBoxes} name="firstName" type="input" value={this.state.firstName} onChange={this.handleChange} />
                </div>
                <div>
                    <p className={styles.nameStyles}>Player From</p>
                    <input  class={styles.inputBoxes} name="lastName" type="input" value={this.state.lastName} onChange={this.handleChange} />
                </div> 
                
                <div>     
                    <p className={styles.nameStyles}>Select The Price</p>
                    <input type="checkbox" name="bowler" checked={this.state.bowler}  onChange={this.handleChange}/> a) 5Cr <br/>
                    <input type="checkbox" name="batsman" checked={this.state.batsman} onChange={this.handleChange}/> b) 8Cr <br/>
                    <input type="checkbox" name="allrounder" checked={this.state.allrounder}  onChange={this.handleChange}/> c) 10Cr <br/>
                </div>
                <button className={styles.btnStyles} onClick={ () => this.submitRegistration() }>Submit</button>
                <PlayerList items={this.state.items} removeItem={this.removeItem} />
            </div>
        ) 
    }
